...
(10, 1, '2018-12-13 14:11:58.000000', 'R001', '0', '0', '2018-12-13 22:13:09.000000', 'D001'),
(11, 2, '2018-12-13 14:13:37.000000', 'R001', '0', '1', NULL, NULL);
...
--
DELIMITER $$
CREATE TRIGGER `5` AFTER UPDATE ON `on_duty_designer` FOR EACH ROW BEGIN
...
ALTER TABLE `waitingdes`
  ADD PRIMARY KEY (`desNo`),
  ADD UNIQUE KEY `desNo` (`desNo`),
  ADD KEY `desState` (`desState`);
...
--
ALTER TABLE `cq2_number`
  MODIFY `numID` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
